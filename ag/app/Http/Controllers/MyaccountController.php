            ...
            if($chk->agent_level == 'PL')
            {
                ...
                if(!empty($getresult))
                {
                    foreach($getresult as $data)
                    {
                        ...
                        $ttlAmto=0;$sumAmto=0;$sumAmt=0;$ttlAmt=0; $ttlAmtb=0;$sumAmtb=0;$sumAmt1=0;$sumAmt2=0;$ttlodd=0;
   ...
   /* public function getHistoryPL(Request $request)
    ...
    public function back_accountstmtdata(Request $request)
    {
        ...
        if($drpval == '0')
        {
            ...
            $ttlAmt=0;$ttlAmto=0;$ttlAmtb=0;$i=2; $blnc=0;$sumAmt=0;$sumAmto=0;$sumAmtb=0;$commn=0;$bttl=0;
        ...
        if($drpval == '1')
        {
            ...
            $i=2;$blnc=0; $data_arr = array();$bttl=0;
