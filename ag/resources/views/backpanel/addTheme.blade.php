                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="timeblock light-grey-bg-2">
                            <form method="post" action="{{route('insertTheme')}}" id="agentform" autcomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-20 match_form profile-wrap">
                                    <div class="col-lg-12 col-md-12col-sm-12 pl-0">
                                        <div class="grey-bg head text-color-white"> Theme </div>
                                        <div class="profile-detail white-bg">
                                            <div class="profile-main">
                                                <div class="headlabel">Theme Name </div>
                                                <div class="headdetail"> <input type="text" name="theme_name" id="theme_name" placeholder="" value="" class="form-control"> </div>
                                            </div>
                                            <div class="profile-main">
                                                <div class="headlabel">Main Theme</div>
                                                <div class="headdetail"> <input type="text" name="main_theme" id="main_theme" placeholder="" value="" class="form-control"> </div>
                                            </div>

                                            <div class="profile-main">
                                                <div class="headlabel">Remark</div>
                                                <div class="headdetail"> <input type="text" name="header_theme" id="header_theme" placeholder="" value="" class="form-control"> </div>
                                            </div>
                                            <div class="profile-main">
