                ...
                <table class="table custom-table balance-table white-bg text-color-blue-2 search-result">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="white-bg amount-deposit">
                                <ul class="deposit-btn">
                                    <li>
                                	   <a id="dBtn" data-pid="{{$i}}" class="logbtn grey-gradient-bg depositebtn selectD">D</a>
                                        <input type="hidden" name="player_deposite[{{$i}}]" id="player_deposite{{$i}}" value="D" />
                                    </li>
                                    <li>
                                ...
                                <input type="text" name="txtamount[{{$i}}]" id="txtamount{{$i}}"  class="form-control allowNumeric" placeholder="0">
                            ...
                            <td class="white-bg">
                                <div class="credit-amount" id="credit_amount_div{{$i}}">
                                    ...
                                    <a style="margin-right: 10px;" id="{{$players->id}}"  class="text-color-blue-light ">{{$credit}}</a>
                                    <a id="btnEdit{{$i}}" data-credit="{{$i}}" class="logbtn grey-gradient-bg creditEdit creditbtn">Edit</a>
                                </div>
                            </td>
                            <!-- ss comment -->
                        ...
                        if($refPL < 0){
                            ...
                            <td class="white-bg"> <input type="text" name="remark[{{$i}}]" id="remark{{$i}}" value="Deposit" class="form-control" placeholder="Remark"> </td>
                        </tr>
					    <?php $no++; $i++; ?>
                         <?php
                        $totBal += $balance;
                        ...
                        ?>
                        @endforeach
                        <tr ><td><b>Total</b></td><td><b>{{number_format($totBal,2, '.', '')}}</b></td><td ><b>{{number_format($totAvl,2, '.', '')}}</b></td><td><span class="text-color-red"><b>({{number_format(abs($totExp),2, '.', '')}})</b></span></td><td></td><td><b style="justify-content: center;display: flex;">{{number_format($totcRef,2, '.', '')}}</b></td><td class="{{$classref}}"><b>({{number_format(abs($totrPL),2, '.', '')}})</td></tr>
                    </tbody>
                </table>
