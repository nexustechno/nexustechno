                            ...
                            <div class="datediv1">
                                <div class="datediv">
                                    <input type="text" name="date_from" id="date_from"
                                           class="form-control period_date5b" placeholder="{{date('d-m-Y')}}"
                                           value="{{date('d-m-Y')}}">
                                ...
                                <div class="datediv">
                                    <input type="text" name="date_to" id="date_to" class="form-control period_date6b"
...
{{--                    <div class="timeblock-box">--}}
                        <ul>
                            <li><a class="justbtn grey-gradient-bg text-color-black1" onclick="getHistory('today',1)">
                                    Just For Today </a></li>
                            <li><a class="submit-btn text-color-yellow" onclick="getHistory('history',1)"> Get
                                    History </a></li>
                        </ul>
                    </div>
                </div>
            ...
            <p>
                ...
                Specify the time period during which your bets were placed, the type of markets on which the bets were
