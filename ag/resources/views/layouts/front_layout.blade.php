                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <ul>
                                            ...
                                            {{--<li><a class="dropdown-item" href="{{route('casinoreport')}}">Casino Result</a></li>--}}
                                                ...
                                                <li class="logout"><a href="{{ route('frontLogout') }}" class="darkblue-bg1 text-color-white">LOGOUT <img src="{{ URL::to('asset/front/img/logout-white.svg')}}"></a></li>
                    ...
                    <div class="loginright-block">
                        ...
                        <form method="post" action="{{route('frontLogin')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="validationcodefront" id="validationcodefront" placeholder="Validation Code" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.result=='msgsuccess'){
                 ...
                 if (data != '') {
                    var spl = data.split('~~');
                    $('.cricketCount').html(spl[0]);
                    $('.tennisCount').html(spl[1]);
                    $('.soccerCount').html(spl[2]);
                }
...
$('.period_date9').datepicker({
 ...
 /*$('#validationcodefront').on('keyup', function () {
    alert("hii");

    var regex = /^[0-9]*$/;

    var code=$('#validationcodefront').val();
    alert(code);

    var chk =regex.test(code);
    if(chk == false){
        return false;
    }
    else{
