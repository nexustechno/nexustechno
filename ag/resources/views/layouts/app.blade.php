                    ...
                    <div class="row">
                        ...
                        <ul class="account-wrap">
                            ...
                            <li class="main-pth text-color-yellow1">
                                <a>
                                    <span class="black-bg text-color-white">Main</span><strong id="myadminbalance">{{ $website->currency }} {{number_format($balance,2, '.', '')}}</strong>
                                </a>
                                            ...
                                            <ul class="black-bg1">
                                                ...
                                                @if($ttuser->agent_level == 'COM')
                                                    <li <?php if($page2=='commision-report') { ?> <?php } ?>>
                                                        <a href="{{route('commision-report')}}" class="text-color-yellow1">Commission Report</a>
                                                    </li>
                                                @endif


                                                <li class="{{ (request()->is('account/statement' )) ? 'active' : '' }}">
                                                    <a href="{{route('account.statement')}}" class="text-color-yellow1">Account Statement</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                        ...
                                        <li <?php if($page2=='betlistlive') { ?> class="active casino-menu" <?php } ?> class="casino-menu">
                                        ...
                                        <li class="{{ (request()->is('risk-management*' )) ? 'active' : '' }}">
                                            <a href="{{route('backpanel/risk-management')}}" class="text-color-white">Risk Management</a>
                                        </li>
                                        @endif
                                            ...
                                            <li  class="has-sub {{ (request()->is('agent-banking' ) || request()->is('player-banking' )) ? 'active' : '' }}">
                                                ...
                                                <ul class="black-bg1">
                                                    @if($ttuser->agent_banking ==  1 || $ttuser->agent_level == 'COM' || $ttuser->agent_level == 'MDL' || $ttuser->agent_level ==  'SMDL' || $ttuser->agent_level ==  'AD' || $ttuser->agent_level ==  'SP')
                                                        <li>
                                                            <a href="{{route('backpanel/agent-banking')}}" class="text-color-white">Agent Banking</a>
                                                        </li>
                                                    @endif
                                                        ...
                                                        <li>
                                                            <a href="{{route('backpanel/player-banking')}}" class="text-color-white">Player Banking</a>
                                                        </li>
                                                    @endif
                                                </ul>
                                            </li>
