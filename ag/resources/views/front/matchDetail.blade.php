                ...
                <div class="middle-wraper">
                    ...
                    @if(Session::get('playerUser') && $inplay=='True')
                        @if($match->sports_id == '1')
                            <div class="match-innerbg-detail soccerbg">
            					<iframe src="https://score.sportside9.com/#/?params=<?php echo $match->event_id;?>&param=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            @endif
                            @if($match->sports_id == '2')
                            <div class="match-innerbg-detail tennisbg">
                                <div class="match-banner tennis">
        							<iframe src="https://score.sportside9.com/#/?params=<?php echo $match->event_id;?>&param=2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        						</div>
                            </div>
                            @endif
                            @if($match->sports_id == '4')
                            <div class="match-innerbg-detail cricketbg">
                                <div class="match-banner cricket">
                                    <iframe src="https://score.sportside9.com/#/?params=<?php echo $match->event_id;?>&param=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div> <!-- match-banner -->
                            </div>
                        @endif
                    @endif
                    ...
                    <div class="match-tracktop black-bg1 text-color-white">
                        <div class="three-tag">
                            ...
                            <div class="timeblockireland"> <img src="{{ URL::to('asset/front/img/clock-icon.png') }} "> {{date('H:i',strtotime($match['match_date']))}} </div>
                        </div>
