...
<?php /*?><link href="https://unpkg.com/video.js/dist/video-js.css" rel="stylesheet">
<script src="https://unpkg.com/video.js/dist/video.js"></script>
<script src="https://unpkg.com/videojs-contrib-hls/dist/videojs-contrib-hls.js"></script><?php */?>
...
<script type="text/javascript">
    ...
    {
        $('.td_team1_bm_back_0').addClass('blue-dark');
        $('.td_team2_bm_back_0').removeClass('blue-dark');
        $('.td_team1_bm_lay_0').removeClass('pink-dark');
        $('.td_team2_bm_lay_0').removeClass('pink-dark');
    });
    ...
    {
        $('.td_team2_bm_back_0').addClass('blue-dark');
        $('.td_team1_bm_back_0').removeClass('blue-dark');
        $('.td_team1_bm_lay_0').removeClass('pink-dark');
        $('.td_team2_bm_lay_0').removeClass('pink-dark');
    });
    ...
    {
        $('.td_team1_bm_lay_0').addClass('pink-dark');
        $('.td_team2_bm_back_0').removeClass('blue-dark');
        $('.td_team1_bm_back_0').removeClass('blue-dark');
        $('.td_team2_bm_lay_0').removeClass('pink-dark');
    });
    ...
    {
        $('.td_team2_bm_lay_0').addClass('pink-dark');
        $('.td_team1_bm_lay_0').removeClass('pink-dark');
        $('.td_team2_bm_back_0').removeClass('blue-dark');
        $('.td_team1_bm_back_0').removeClass('blue-dark');
    });
