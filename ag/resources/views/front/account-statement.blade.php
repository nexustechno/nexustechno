                            ...
                            <div class="m-t-20">
                                <div class="row datediv1">
                                    <div class="col-md-2 datediv">
                                        <input name="fromdate" id="fromdate" class="form-control period_date5" type="text" autocomplete="off" placeholder="{{date('d-m-Y')}}" value="{{date('d-m-Y')}}">
                                        <img src="{{ URL::to('asset/img/calendar-icon.png') }}" class="calendar-icon_2" style="top:5px;">
                                    </div>

                                    <div class="col-md-2 datediv">
                                        <input name="todate" id="todate" class="form-control period_date6" type="text" readonly="" autocomplete="off" placeholder="{{Date('d-m-Y', strtotime('+1 days'))}}" value="{{Date('d-m-Y', strtotime('+1 days'))}}">
                                        <img src="{{ URL::to('asset/img/calendar-icon.png') }}" class="calendar-icon_2" style="top:5px;">
                                    </div>
