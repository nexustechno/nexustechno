  ...
  <div class="container">
    <div class="remaining-wrap white-bg text-color-blue-1">
      ...
      <div class="block-remain">
        ...
        <h4>PTH {{number_format($calData[0],2, '.', '')}}</h4>
      </div>
      @endif
      <div class="block-remain">
        <span class="text-color-lght-grey">Total Client Balance</span>
        <h4>PTH {{number_format($calData[1],2, '.', '')}}</h4>
      </div>
      <div class="block-remain">
        <span class="text-color-lght-grey">Exposure</span>
        <h4>PTH <div class="text-color-red">({{number_format(abs($calData[2]),2, '.', '')}})</div></h4>
      </div>
      <div class="block-remain">
      ...
      <div class="block-remain">
        ...
        <h4>PTH <div class="exp_div" id="ledger_exposure_div">0.00</div></h4>
      </div>
    </div>
  </div>
</section>