            ...
            <div class="timeblock light-grey-bg-2">
                <div class="timeblock-box">
                    ...
                    <div class="datebox">
                        ...
                        <div class="datediv1">
                            <div class="datediv">
                                <input type="text" name="fromdate" id="fromdate" class="form-control period_date_plf" placeholder="{{Date('d-m-Y')}}" value="{{Date('d-m-Y')}}">
                            ...
                            <div class="datediv">
                                <input type="text" name="todate" id="todate" class="form-control period_date_plt" placeholder="{{Date('d-m-Y', strtotime('+1 days'))}}" value="{{Date('d-m-Y', strtotime('+1 days'))}}">
                                <img src="{{ URL::to('asset/img/calendar-icon.png')}}" class="calendar-icon">
                            </div>
