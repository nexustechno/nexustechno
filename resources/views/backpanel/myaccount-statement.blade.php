			...
			<div class="col-lg-9 col-md-9 col-sm-12">
					...
					<form>
                        <div class="row">
							...
							<div class="col-md-3">
								<label>From: </label>
								<input name="fromdate" id="fromdate" class="form-control period_date1" type="text" placeholder="{{date('d-m-Y')}}" value="{{date('d-m-Y')}}">
							</div>
							<div class="col-md-3">
								<label>To: </label>
								<input name="todate" id="todate" class="form-control period_date2" type="text" placeholder="{{Date('d-m-Y', strtotime('+1 days'))}}" value="{{Date('d-m-Y', strtotime('+1 days'))}}">
							</div>
							<div class="col-md-1">
                            	<label> &nbsp; </label>
