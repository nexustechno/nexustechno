                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                        ...
                                        @if(Session::get('playerUser') && $inplay=='True')
                                            <iframe src="https://vid.dreamcasino.live/html/<?php echo $eventid;?>.html" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        @endif -->
                                    <?php 
                                        $eventid= $match->event_id;
                                        $sprtid= $match->sports_id;
                ...
                <div class="middle-wraper">
                    ...
                    @if(Session::get('playerUser'))
                        ...
                        <div class="match-innerbg-detail soccerbg">
                            <iframe src="https://betproexch.com/Common/LiveScoreCard?id=<?php echo $match->match_id;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    @endif
                        ...
                        <div class="three-tag">
                            ...
                            $match_date='';
                                ...
                                if($match['sports_id'] == 4 && isset($match_data['t1'][0][0]['iplay']) && $match_data['t1'][0][0]['iplay'] === 'True'){
                                    ...
                                    $match_time = "<span>".date('H:i:s A',strtotime($match['match_date']))."</span>";
                                }
                                ?>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                                        ...
                                                        <!-- @if(Session::get('playerUser') && $inplay=='True')
                                                            ...
                                                            <iframe src="https://vid.dreamcasino.live/html/<?php echo $eventid;?>.html" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen id="iframe"></iframe>
                                                        ...
                                                        $sprtid= $match->sports_id;
                                                            ...
                                                            $live_match_data = json_decode($return, true);
                                                            
                                                            //echo"<pre>"; print_r($live_match_data); echo"<pre>";
                                                                if(!empty($live_match_data) && !empty($live_match_data['result'])){
                                                                foreach ($live_match_data as $tvdata) {
                                                                foreach ($tvdata as $tvdata1) {
                                                                        if($tvdata1['Message'] =='Successful' && $tvdata1['SportId'] == $sprtid)
                                                                        { 
                                                                            ?>
...
/*$(document).ready(function(){
    var ttle = $('#iframe').contents().find('error-template').text();
...
<script>
    ...
    $("#cancel_bet_form").click(function() {  console.log('cancel1');
        ...
        // odds
         ...
         $('#team1_bet_count_old').show();
        $('#team2_bet_count_old').show();
        $('#draw_bet_count_old').show();
    ...
    $(document).ready(function() {
        ...
        setInterval(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
					...
					else
					{
						...
						{
							$('#team1_total').text(parseFloat(team1total).toFixed(2));
						}
						if($('#team2_total').text()!=team2total  && team2total!='')
						{
							$('#team2_total').text(parseFloat(team2total).toFixed(2));
						}
						if($('.totselection').text()=='3 Selections')
						{
							...
							{   
								$('#team3_total').text(parseFloat(team3total).toFixed(2));
							}
						}
			...
			if($('#is_session_open_position').val()=='' || $('#is_session_open_position').val()==' '){ console.log('fanc');
				$.ajax({
					type: "POST",
        ...
        if ($('#betTypeAdd').val() == 'ODDS' && $('#betTypeAdd').val() != 'SESSION') {
            if ($('#betSide').val() == 'back') {
                if (old_team1.trim() == team.trim()) {
                    ...
                    if (finalValue > 0) {
						$('#team1_bet_count_new').text(finalValue.toFixed(2));
                        $('#team1_bet_count_new').removeClass('tolose towin text-color-red');
                        $('#team1_bet_count_new').addClass(' text-color-green');
                    } else {
						$('#team1_bet_count_new').text(parseFloat(finalValue).toFixed(2));
                        $('#team1_bet_count_new').addClass(' text-color-red');
                        $('#team1_bet_count_new').removeClass('towin tolose text-color-green');
                    }
                    fval_new = '';
                    var old_value_team2 = $('#team2_total').text();
                    if (old_value_team2 != '') {
                    ...
                    if (fval_new > 0) {
                        $('#team2_bet_count_new').removeClass('tolose  towin text-color-red');
                        $('#team2_bet_count_new').addClass(' text-color-green');
                        $('#team2_bet_count_old').hide();
                        $('#team2_bet_count_new').show();
                        $('#team2_bet_count_new').text(fval_new);
                    } else {
                        $('#team2_bet_count_new').addClass(' text-color-red');
                        $('#team2_bet_count_new').removeClass('towin tolose text-color-green');
                        $('#team2_bet_count_old').hide();
                        $('#team2_bet_count_new').show();
                        $('#team2_bet_count_new').text(fval_new);
                    }
                    ...
                    if ($('#team3').val() != '') {
                        ...
                        if (fval > 0) {
                            $('#draw_bet_count_new').removeClass('tolose towin text-color-red');
                            $('#draw_bet_count_new').addClass(' text-color-green');
                            $('#draw_bet_count_old').hide();
                            $('#draw_bet_count_new').show();
                            $('#draw_bet_count_new').text(fval);
                        } else {
                            $('#draw_bet_count_new').addClass(' text-color-red');
                            $('#draw_bet_count_new').removeClass('towin tolose text-color-green');
                            $('#draw_bet_count_old').hide();
                            $('#draw_bet_count_new').show();
                            $('#draw_bet_count_new').text(fval);
                        }
                ...
                if (old_team1.trim() == team.trim()) {
                    ...
                    if (fval_new > 0) {
                        $('#team2_bet_count_new').removeClass('towin tolose text-color-red');
                        $('#team2_bet_count_new').addClass(' text-color-green');
                        $('#team2_bet_count_old').hide();
                        $('#team2_bet_count_new').show();
                        $('#team2_bet_count_new').text(fval_new.toFixed(2));
        ...
        if ($('#betTypeAdd').val() == 'ODDS' && $('#betTypeAdd').val() != 'SESSION') {
            if ($('#betSide').val() == 'back') {
                if (old_team1.trim() == team.trim()) {
                    ...
                    if (finalValue > 0) {
						$('#team1_bet_count_new').text(finalValue.toFixed(2));
                        $('#team1_bet_count_new').removeClass('towin tolose text-color-red');
                        $('#team1_bet_count_new').addClass(' text-color-green');
                    } else {
						$('#team1_bet_count_new').text(parseFloat(finalValue).toFixed(2));
                        $('#team1_bet_count_new').addClass(' text-color-red');
                        $('#team1_bet_count_new').removeClass('tolose towin text-color-green');
                    }
                    fval_new = '';
                    var old_value_team2 = $('#team2_total').text();
                    if (old_value_team2 != '') {
            ...
            if ($('#betSide').val() == 'back') {
                if (old_team1.trim() == team.trim()) {
                    ...
                    if (fval_new > 0) {
                        ...
                        $('#team2_bet_count_new').addClass('text-color-red');
                        $('#team2_bet_count_new').removeClass('tolose  towin text-color-green');
                        $('#team2_bet_count_old').hide();
                        $('#team2_bet_count_new').show();
                        $('#team2_bet_count_new').text(fval_new);
                    }
                    ...
                    if ($('#team3').val() != '') {
                        ...
                        if (fval > 0) {
                            ...
                            $('#draw_bet_count_new').addClass(' text-color-red');
                            $('#draw_bet_count_new').removeClass('tolose towin text-color-green');
                            $('#draw_bet_count_old').hide();
                            $('#draw_bet_count_new').show();
                            $('#draw_bet_count_new').text(fval);
                        }
                ...
                if (old_team1.trim() == team.trim()) {
                    ...
                    if ($('#team3').val() != '') {
                        ...
                        if (finalValue > 0) {
                            ...
                            $('#draw_bet_count_new').removeClass(' text-color-green');
                            $('#draw_bet_count_new').addClass('tolose towin text-color-red');
                                                        $('#draw_bet_count_old').hide();
